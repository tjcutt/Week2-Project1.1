/*========================COMPLETED
ONE FORMATTING QUESTION AT THE END
=======================================================
** Week 1 - Project 2 **
...
document.getElementById("dCharacters").addEventListener("click", function() {
    var dLength = document.getElementById("dName").value;
    document.getElementById("qd").innerHTML = dLength.length;
});
...
document.getElementById("eResults").addEventListener("click", function() {
      var results = document.getElementById('eScore').value;
      if (results >= 90) {
        document.getElementById('qe').innerHTML = 'Great job!'
      } else if (results <= 90 && results >=60) {
...
//=============HOW WOULD YOU ADD STYLES TO EACH OUTCOME WHEN THE STILE DEPENDS ON THE OUTCOME?
